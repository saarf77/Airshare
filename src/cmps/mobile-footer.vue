    ...
    <section class="mobile-footer">
        <nav v-if="!desktop">
            <div class="links-container">
                <a @click="loggedinUser()"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="#/wishlist" @click="showMenu = !showMenu"><svg viewBox="0 0 32 32"
                ...
                <a @click="usersTrips"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                ...
                <a @click="logout" v-if="getLogInUser"><img src="src\assets\img\icons\logout1.png" alt=""></a>
                <a @click="login" v-if="!getLogInUser"><img src="src\assets\img\icons\login.png" alt=""></a>
            </div>
        </nav>
    </section>
</template>
